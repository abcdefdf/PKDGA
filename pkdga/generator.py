...
class Generator(nn.Module):
    """Generator """
    def __init__(self, num_emb, emb_dim, hidden_dim, use_cuda, num_layers):
    ...
    def forward(self, x):
        ...
        emb = self.emb(x)  # [64, 100, 32]
        h0, c0 = self.init_hidden(x.size(0))
        output, (h, c) = self.lstm(emb, (h0, c0))   # output [64, 100, 32]
        pred = self.softmax(self.lin(output.contiguous().view(-1, self.hidden_dim)))  # pred [6400,38]
        return pred
